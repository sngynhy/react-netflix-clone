...
export const BackdropImage = ({id, mType, title, showPlayButton=false, showTitle=false, imgPath, width='120px', height='60px', isHovered=false}) => {
    return (
        <>
            {/* <div className="backdrop-img" style={{position: 'relative', cursor: 'pointer', transition: "transform 0.3s ease", transform: isHovered ? "scale(1.2)" : "scale(1)", }}> */}
